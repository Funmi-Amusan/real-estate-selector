...
export default function Home() {
  return (
    <section className="h-screen pt-16">
      <h1 className="text-center font-bold text-2xl md:text-3xl uppercase">Explore Towers</h1>
  ...
  />
     ...
     <p className="flex items-center uppercase font-semibold text-lg">{tower.name} </p>
      </Link>
    ))}
  </div>
    </section>
